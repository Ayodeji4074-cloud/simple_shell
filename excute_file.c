#include "shell.h"
/**
 * read_file - This  Read Command From File
 * @filename:Filename
 * @argv:Program Name
 * Return: -1 or  0
 */
...
/**
 * treat_file - This PARSE Check Command Fork Wait Excute in Line of File
...
/**
 * exit_bul_for_file - This Function  Exit Shell Case Of File
 * @line: Line From A File
 * @cmd: Parsed Command
 * @fd:File Descriptor
